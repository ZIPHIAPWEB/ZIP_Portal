...
theme_color="#1b2754">
    ...
    <header class="program-header" style="background-image: url(&quot;assets/img/caree.jpg&quot;);background-size: cover;background-position: center;background-repeat: no-repeat;"></header>
    <section class="p-5">
            ...
            <div class="row mt-3">
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3 d-flex justify-content-center align-items-center">
                    <div class="d-xl-flex flex-column justify-content-xl-center align-items-xl-center z-card"><img alt="Image containing a circle with a number 18 in the center and a plus sign on the top" src="assets/img/plus-18-movie.png" width="120px">
                        <h6 class="text-center text-white mt-3">Must be 18 to 26 years old</h6>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3 d-flex justify-content-center align-items-center">
                    <div class="d-xl-flex flex-column justify-content-xl-center align-items-xl-center z-card"><img alt="Image containing a diploma with white shade" src="assets/img/contract.png" width="120px">
                        <h6 class="text-center text-white mt-3">Must have a degree certificate from an academic institution</h6>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3 d-flex justify-content-center align-items-center">
                    <div class="d-xl-flex flex-column justify-content-xl-center align-items-xl-center z-card"><img alt="Image containing a handshake with three people behind" src="assets/img/team.png" width="120px">
                        <h6 class="text-center text-white mt-3">Must have a minimum of one year work experience</h6>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3 d-flex justify-content-center align-items-center">
    ...
    <section class="p-5">
        <div class="container-fluid">
            <p class="text-justify text-xl-center">Participants gain the opportunity to enhance their skills and expertise in their academic or occupational fields through participating in a guided training-based program.</p>
        </div>
    </section>
