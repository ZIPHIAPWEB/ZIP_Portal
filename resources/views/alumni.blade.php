            ...
            <div class="row">
                ...
                <div class="col-12 m-2 d-flex blog-item">
                    ...
                    <div class="blog-item-content d-flex flex-column">
                        <h3><a href="{{ url('/alumni/' . $blog->slug) }}">{{ $blog->title }}</a></h3>
                        <span>{{ $blog->created_at->diffForHumans() }}</span>
                        <p class="text-justify mt-2">{{ $blog->initial_content }}</p>
                        <a target="_blank" href="{{ url('/alumni/' . $blog->slug) }}" class="btn btn-outline btn-primary" style="width: 120px; margin-bottom: 7px;">Read More</a>
                        <div class="fb-share-button" 
                            data-href="{{ url('/alumni/' . $blog->slug) }}" 
                            data-layout="button"
                            data-size="large">
                        </div>
                    </div>
