...
<body>
    ...
    <header class="program-header" style="background-image: url(&quot;assets/img/USA%20PROGRAM-1.jpg&quot;);background-size: cover;background-position: bottom;background-repeat: no-repeat;"></header>
    ...
    <section class="p-5">
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h3 class="text-center" style="font-weight: bold;">APPLICATION GUIDE</h3>
                </div>
            </div>
            <div class="row mt-4">
    ...
    <section data-bs-parallax-bg="true" class="p-5" style="background-image: url(&quot;assets/img/OTHER%20PROGRAMS-1.jpg&quot;);background-size: cover;background-repeat: no-repeat;background-position: center;">
        <div class="container-fluid text-justify text-xl-center">
            <div class="row">
                <div class="col">
                    <h3 class="text-center text-white" style="font-weight: bold;">OTHER PROGRAMS</h3>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-2">
                    <div class="card d-md-flex flex-fill justify-content-md-center">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-2">
                    <div class="card d-md-flex flex-fill justify-content-md-center align-items-md-center">
    ...
    <section class="p-5">
        <div class="container-fluid text-justify text-xl-center">
            <p class="text-center" style="font-style: italic;">We provide intercultural opportunities to Filipino and foreign students to help them become familiar with international work standards through diffrent types of international-based training.&nbsp;<br></p>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col text-justify">
                    ...
                    <ul>
                        ...
                        <li><a href="#">(02)559-8213</a></li>
                        <li><a href="#">(02)692-0907</a></li>
                        <li><a href="#">0917-522-8213</a></li>
                    </ul>
                </div>
                <div class="col text-justify">
                    ...
                    <ul>
                        ...
                        <li><a href="#">0906-371-5897</a></li>
                        <li><a href="#">0922-876-8213</a></li>
                    </ul>
                </div>
                <div class="col text-justify">
                    ...
                    <ul>
                        ...
                        <li><a href="#">0915-315-2838</a></li>
                        <li></li>
                        <li><a href="#">0967-243-2499</a></li>
                    </ul>
                </div>
                <div class="col text-justify">
                    <h6>CEBU OFFICE</h6>
                    <ul>
                        ...
                        <li><a href="#">(032)266-8840</a></li>
                        <li></li>
                        <li><a href="#">0915-875-7618</a></li>
                    </ul>
                </div>
                <div class="col text-justify">
                    <h6>DAVAO&nbsp;OFFICE</h6>
                ...
                <div class="col-xl-12">
                    <div class="text-center" style="margin: 10px;"><a href="#" style="margin: 10px;"><i class="fa fa-facebook" style="font-size: 15px;"></i></a><a href="#" style="margin: 10px;"><i class="fa fa-instagram" style="font-size: 15px;"></i></a><a href="#" style="margin: 10px;"><i class="fa fa-twitter" style="font-size: 15px;"></i></a>
                        <a
                            href="#" style="margin: 10px;"><i class="fa fa-youtube-play" style="font-size: 15px;"></i></a><a href="#" style="margin: 10px;"><i class="fa fa-envelope" style="font-size: 15px;"></i></a></div>
                </div>
