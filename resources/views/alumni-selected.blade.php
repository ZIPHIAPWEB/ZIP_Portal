...
<html>
    ...
    <head>
        ...
        <meta property="og:url" content="{{ url('/alumni/' . $blog->slug) }}" />
        <meta property="og:title" content="{{ 'ZIP Travel PH - ' . $blog->title }}" />
...
theme_color="#1b2754">
    ...
    <section class="section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 m-2 d-flex flex-column justify-content-center align-items-center">
