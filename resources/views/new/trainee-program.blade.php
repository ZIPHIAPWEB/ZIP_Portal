    ...
    <div id="heading" class="heading">
        ...
        <div class="heading__content container d-flex d-xxl-flex flex-column justify-content-center align-items-center justify-content-sm-center justify-content-md-end align-items-lg-start h-100">
            <div class="d-flex d-sm-flex d-md-flex d-xxl-flex flex-column justify-content-sm-center align-items-sm-center align-items-md-start justify-content-xxl-start" style="color: #FFFFFF;margin-bottom: 43px;">
                <h1 class="text-center heading__content-title">TRAINEE PROGRAM</h1>
                <p class="text-center text-sm-center text-md-start heading__content-description">
                    Expand your work experience through a practical apprenticeship in the United States under BridgeUSA's Trainee Program.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div style="font-size: 18px;font-family: 'Inter';color: #2A2A2A;">
                <p style="margin-bottom: 25px;">
                    Participants will learn from industry leaders while working in 4 and 5-star hotels and resorts.    
                </p>
            </div>
            <div class="row">
                <div class="col-12" style="font-size: 18px; font-family: 'Inter';">
                    <ul>
                        <li>Application for the J1 Traineeship is open year-round</li>
                        <li>Put your studies into practice and enhance skills related to your field of study</li>
                        <li>Opportunities include positions in culinary, food and beverage, front office, and more!</li>
                        <li>Receive a stipend to support living in the US during the program</li>
            ...
            <div class="row align-items-center" style="margin-top: 56px;">
                ...
                <div class="col-12 d-flex align-items-lg-center" style="font-size: 18px; font-family: 'Inter';">
                    <p>The BridgeUSA Trainee Program is taken in 12 months with a 30-day grace period after the work commitment to travel around the US with their J1 visa.</p>
                </div>
            </div>
            <div class="row align-items-center" style="margin-top: 56px;">
                <div class="col-12">
                    ...
                    <ul class="content-body">
                        <li>Must be under 28 years of age</li>
                        <li>Those who have completed their education and have some professional work experience (at least 12 months) in their respective field</li>
