    ...
    <div id="heading" class="heading">
        ...
        <div class="heading__content container d-flex d-xxl-flex flex-column justify-content-center align-items-center justify-content-sm-center justify-content-md-end align-items-lg-start h-100">
            <div class="d-flex d-sm-flex d-md-flex d-xxl-flex flex-column justify-content-sm-center align-items-sm-center align-items-md-start justify-content-xxl-start" style="color: #FFFFFF;margin-bottom: 43px;">
                <h1 class="text-center heading__content-title">SUMMER WORK TRAVEL PROGRAM</h1>
                <p class="text-center text-sm-center text-md-start heading__content-description">The Summer Work Travel program offers an enriching experience that combines cultural immersion, work experience, and exploration of the United States.</p>
            </div>
        </div>
    </div>
    <!-- Start: about-us -->
    <section style="padding: 75px 0;" class="px-2 px-md-0">
        <div class="container">
            <div style="font-size: 18px;font-family: 'Inter';color: #2A2A2A;">
                <p style="margin-bottom: 25px;">The Summer Work Travel Program is for enrolled college and university students in the Philippines interested in experiencing living and working in the United States during their school summer vacation.</p>
            </div>
            <div class="row">
                <div class="col-12" style="font-size: 18px; font-family: 'Inter';">
                    <ul>
                        <li>Open to currently enrolled college and university students of any course</li>
                        <li>Exciting work opportunities in hotels, restaurants, amusement parks, retail stores, and ski resorts</li>
                        ...
                        <li>Discover and understand US work culture and practices</li>
                        <li>Enhance your English language competency by living and interacting in an English-speaking environment</li>
                        <li>Receive a competitive stipend to support your living and travel expenses during the program</li>
                        <li>Medical insurance coverage</li>
                        <li>Overtime and an additional part-time job are allowed but should be responsibly managed</li>
                        <li>Past participants can reapply for the program</li>
                    </ul>
                </div>
            </div>
            <div class="row align-items-center" style="margin-top: 56px;">
                ...
                <div class="col-12 d-flex align-items-lg-center" style="font-size: 18px; font-family: 'Inter';">
                    <p>The Summer Work Travel is a three-month program (from March to June or from May to August). Participants must return to their home country when classes begin.</p>
                </div>
            </div>
            <div class="row align-items-center" style="margin-top: 56px;">
                <div class="col-12">
                    ...
                    <ul class="content-body">
                        ...
                        <li>Currently enrolled first, second, or third-year college or university student</li>
                        <li>Have completed at least one semester or equivalent</li>
    ...
    <section class="d-xl-flex justify-content-xl-center align-items-xl-center app-guide-section">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="d-flex d-xl-flex align-items-center align-items-xl-center app-guide-sequence-item">
                        <div class="d-flex justify-content-center align-items-center app-guide-sequence-item__step">
                            <span>04</span>
                        </div>
