    ...
    <section style="padding: 75px 0;">
        <div class="container">
            ...
            <div class="row" style="margin-top: 60px;">
                <div class="col">
                    <div style="width: 100%;height: 434px;border-radius: 40px;box-shadow: 10px 13px 20px 0px var(--bs-secondary-color);"><img style="height: 352px;width: 100%;object-fit: cover;" src="assets_v3/img/Rectangle%2011%20(5).png">
                ...
                <div class="col">
                    <div style="width: 100%;height: 434px;border-radius: 40px;box-shadow: 10px 13px 20px 0px var(--bs-secondary-color);"><img style="height: 352px;width: 100%;object-fit: cover;" src="assets_v3/img/Rectangle%2020.png">
                        <div class="d-flex justify-content-center align-items-center" style="height: 82px;width: 100%;">
