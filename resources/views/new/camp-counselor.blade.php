            ...
            <div class="row align-items-center" style="margin-top: 56px;">
                ...
                <div class="col-12">
                    <div class="d-flex d-xl-flex flex-row align-items-lg-center align-items-xl-center" style="padding: 15px 0;">
                        ...
                        <p style="font-family: 'Inter';font-style: normal;font-size: 18px;">Currently enrolled first, second, or third-year college or university student</p>
                    </div>
                </div>
                <div class="col-12">
                    <div class="d-flex d-xl-flex flex-row align-items-lg-center align-items-xl-center" style="padding: 15px 0;">
                        ...
                        <p style="font-family: 'Inter';font-style: normal;font-size: 18px;">Have completed at least one semester or equivalent</p>
                    </div>
                </div>
                <div class="col-12">
                    <div class="d-flex d-xl-flex flex-row align-items-lg-center align-items-xl-center" style="padding: 15px 0;">
